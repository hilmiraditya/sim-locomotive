            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nama_klien">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="alamat_klien">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Perusahaan :</label>
                  <input class="form-control" type="text" name="perusahaan_klien">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Jabatan :</label>
                  <input class="form-control" type="text" name="jabatan_klien">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">No. Telfon : <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="notelp_klien">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
