          <div class="form-layout">
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                ...
                <input type="text" name="preview_pertama" class="form-control fc-datepicker" placeholder="MM/DD/YYYY">
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                <input type="text" name="jadwal_1" class="form-control fc-datepicker" placeholder="MM/DD/YYYY">
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                <input type="text" name="jadwal_2" class="form-control fc-datepicker" placeholder="MM/DD/YYYY">
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                <input type="text" name="serah_terimah" class="form-control fc-datepicker" placeholder="MM/DD/YYYY">
              </div>
              </div><!-- col-4 -->
            </div><!-- row -->
          </div><!-- form-layout -->