    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{'/Staff/Pesanan/DaftarPesanan'}}" class="nav-link">Daftar Pesanan</a></li>
          <li class="nav-item"><a href="{{ '/Staff/Pesanan/TambahPesanan' }}" class="nav-link">Tambah Pesanan</a></li>
        </ul>
      </div>
      <br>
    </div>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{url('Staff/PengaturanAkun')}}"><i class="icon ion-ios-gear-outline"></i>Pengaturan Akun</a></li>
              </ul>
              <ul class="list-unstyled user-profile-nav">
                <li>
