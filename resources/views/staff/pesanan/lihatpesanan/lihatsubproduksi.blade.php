          <div class="form-layout">
            ...
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="unit_produksi" value="{{$view['pesanan']->unit_produksi}}" disabled>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Produksi : <span class="tx-danger">*</span></label>
                  <textarea class="form-control" type="text" name="deskripsi_agenda_produksi" disabled>{{$view['pesanan']->deskripsi_agenda_produksi}}
                  </textarea>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" type="text" name="catatan_lain" disabled>
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                ...
                <input type="date" name="preview_pertama" class="form-control" value="{{ $view['pesanan']->preview_pertama}}" disabled>
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                <input type="date" name="jadwal_2" class="form-control" value="{{$view['pesanan']->jadwal_2}}" disabled>
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                <input type="date" name="serah_terimah" value="{{$view['pesanan']->serah_terimah}}" class="form-control" disabled>
              </div>
              </div><!-- col-4 -->
            </div><!-- row -->
          </div><!-- form-layout -->
