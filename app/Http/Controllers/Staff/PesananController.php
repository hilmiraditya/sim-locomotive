...
class PesananController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.pesanan.daftarpesanan')->with(compact('view'));
    }
    public function tambahpesanan_biodata()
    {
    	...
    	return view('staff.pesanan.tambahpesanan.tambah')->with(compact('view'));
    }
    public function get_tambahpesanan_biodata(PesananRequest $request)
    {
    	...
    	return redirect('Staff/Pesanan/DaftarPesanan')->with('pesan_sukses', 'Pesanan berhasil ditambah');
    }
    public function detil_pesanan($id)
    {
        ...
        return view('staff.pesanan.lihatpesanan.lihat')->with(compact('view'));
    }
    public function ubah_pesanan($id)
    {
        ...
        return view('staff.pesanan.ubahpesanan.ubahpesanan')->with(compact('view'));
    }
    public function get_ubah_pesanan(PesananRequest $request,$id)
    {
        ...
        return redirect('Staff/Pesanan/DaftarPesanan')->with('pesan_sukses', 'Pesanan berhasil diupdate');
    }
    public function hapus_pesanan($id)
    {
        Pesanan::find($id)->delete();
        return redirect('Staff/Pesanan/DaftarPesanan')->with('pesan_sukses', 'Pesanan berhasil dihapus');
    }
    public function kirim_email_pesanan($id)
    {
        ...
        Mail::send('Staff.pesanan.email.email', $data, function($message) {
        ...
        $pesanan->isEmailed = 1;
        $pesanan->save();
        return redirect('Staff/Pesanan/DaftarPesanan')->with('pesan_sukses', "Invoice pesanan atas nama ".$data['pesanan']->nama_klien." berhasil dikirim ke ".$data['pesanan']->email_klien);
    }
    public function ubah_status_pesanan(Request $request, $id)
    {
        ...
        $pesanan->save();
        return redirect('Staff/Pesanan/DaftarPesanan')->with('pesan_sukses', 'Status pesanan atas nama '.$pesanan->nama_penginput.' berhasil diubah');   
    }
}
